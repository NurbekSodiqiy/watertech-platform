 ...
 * link to their page. Memoized — the directory holds ~200 of them and a
 * keystroke in the search box must not re-render the ones that stay. Nothing
 * here fetches: every number arrived in `person`. */
export const PersonCard = memo(function PersonCard({ person, windowStart, nowMs }: PersonCardProps) {
