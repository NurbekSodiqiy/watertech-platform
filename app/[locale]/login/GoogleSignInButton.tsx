...
export function GoogleSignInButton() {
  ...
  return (
    <button
      ...
      className="mt-6 flex w-full items-center justify-center gap-2.5 rounded-xl border border-border bg-surface px-4 py-2.5 text-[14px] font-medium text-primary-dark shadow-softer transition-colors hover:bg-surface-alt"
    >
      <GoogleIcon />
      {t("googleSignIn")}
    </button>
