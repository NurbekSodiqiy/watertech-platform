...
export const objections: Objection[] = [
  ...
  },
  {
    ...
    response:
      "Bu juda muhim savol. Bizning fitinglarimiz Yevropa standartlarida aniq kalibrovka qilingan. Bu esa ustalar uchun tezkor va xatosiz o'rnatishni ta'minlaydi. Biz buning uchun maxsus kafolat beramiz. Menejerimizning sinov to'plamini tekshirib ko'ring.",
  ...
  },
  {
    ...
    response:
      "Ustalar bilan hamkorlik asosida ishlashni yo'lga qo'ymoqdamiz, shu sababli har bir tumanda bizning mahsulotlarimiz bo'lishi kerak, o'zingizga ham ma'lumki, bu mahsulotga bo'lgan talab yuqori. Mijoz tomonidan xavotir olmasangiz ham bo'ladi. Marketing tomonidan, ya'ni mijozlarni jalb qilish masalasini biz hal qilamiz.",
